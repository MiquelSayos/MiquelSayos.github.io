...
let Tab2Page = class Tab2Page {
    ...
    ngOnInit() {
        this.dades.totsPaisos().subscribe((data) => {
            this.dadesPaisos = data;
        });
    }
    infoPais(pais) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Countries\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-list *ngIf=\"dadesPaisos\">\n\n    <ion-item *ngFor=\"let pais of dadesPaisos\" (click)=\"infoPais(pais.Country)\">\n      <ion-label>\n        <h2>País: {{pais.Country}}</h2>\n        <h3>ISO2: {{pais.ISO2}}</h3>\n      </ion-label>\n    </ion-item>\n\n  </ion-list>\n</ion-content>\n");
